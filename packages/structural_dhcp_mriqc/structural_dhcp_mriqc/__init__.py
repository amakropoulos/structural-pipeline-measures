...
"""
The structural_dhcp_mriqc package provides a series of :abbr:`NR (no-reference)`,
...
The easiest path is using pypi ::
    ...
    pip install structural_dhcp_mriqc
...
::
    ...
    structural_dhcp_mriqc -i ~/Data/bids_dataset -o out/ -w work/
