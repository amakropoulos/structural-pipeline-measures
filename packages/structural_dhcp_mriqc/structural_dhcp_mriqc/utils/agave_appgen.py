...
import structural_dhcp_mriqc

agaveapp = {
    'name': structural_dhcp_mriqc.__name__,
    'version': structural_dhcp_mriqc.__versionbase__,
    'helpURI': 'http://structural_dhcp_mriqc.readthedocs.org',
    'label': 'structural_dhcp_mriqc',
    'shortDescription': structural_dhcp_mriqc.__description__,
    'longDescription': structural_dhcp_mriqc.__longdesc__,
    'executionSystem': 'slurm-ls5.tacc.utexas.edu',
    'executionType': 'HPC',
    'parallelism': 'PARALLEL',
    'defaultQueue': 'normal',
    'defaultNodeCount': 1,
    'deploymentPath': 'apps/structural_dhcp_mriqc',
