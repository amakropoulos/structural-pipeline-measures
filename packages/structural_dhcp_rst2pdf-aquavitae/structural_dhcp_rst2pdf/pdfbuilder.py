# -*- coding: utf-8 -*-
"""
Sphinx structural_dhcp_rst2pdf builder extension
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Usage:

  1. In conf.py add 'structural_dhcp_rst2pdf.pdfbuilder' element to 'extensions' list:
     extensions = ['structural_dhcp_rst2pdf.pdfbuilder']
...
from structural_dhcp_rst2pdf import createpdf, pygments_code_block_directive
...
class PDFWriter(writers.Writer):
    ...
    def translate(self):
        ...
        if self.use_coverpage:
            ...
            def find_cover(name):
                cover_path = [self.srcdir, os.path.expanduser('~/.structural_dhcp_rst2pdf'),
