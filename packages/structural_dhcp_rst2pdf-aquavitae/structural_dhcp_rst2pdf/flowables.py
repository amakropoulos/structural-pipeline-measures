...
from structural_dhcp_rst2pdf import styles
...
class SetNextTemplate(Flowable):
    ...
    structural_dhcp_rst2pdf uses that to switch page templates.
    """
...
class ResetNextTemplate(Flowable):
    ...
    structural_dhcp_rst2pdf uses that to switch page templates back when
