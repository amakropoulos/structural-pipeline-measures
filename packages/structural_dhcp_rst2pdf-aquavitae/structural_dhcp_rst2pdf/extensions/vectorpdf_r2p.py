...
from structural_dhcp_rst2pdf.opt_imports import LazyImports
...
def install(createpdf, options):
    ''' Monkey-patch this PDF handling into structural_dhcp_rst2pdf
    '''
    LazyImports.pdfinfo = pdfrw
    structural_dhcp_rst2pdf.image.VectorPdf = VectorPdf
