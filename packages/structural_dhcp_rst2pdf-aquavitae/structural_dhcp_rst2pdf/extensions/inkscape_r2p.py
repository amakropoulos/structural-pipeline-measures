...
"""
inkscape.py is an structural_dhcp_rst2pdf extension (e.g. structural_dhcp_rst2pdf -e inkscape xxx xxxx)
...
import structural_dhcp_rst2pdf.image

from structural_dhcp_rst2pdf.log import log
from structural_dhcp_rst2pdf.extensions.vectorpdf_r2p import VectorPdf
...
def install(createpdf, options):
    ...
    """
    structural_dhcp_rst2pdf.image.SVGImage = InkscapeImage
