...
import structural_dhcp_rst2pdf.genelements as genelements
from structural_dhcp_rst2pdf.flowables import Heading, MyPageBreak
from structural_dhcp_rst2pdf.image import MyImage
from structural_dhcp_rst2pdf.opt_imports import Paragraph
...
class FancyTitleHandler(genelements.HandleParagraph, docutils.nodes.title):
    ...
    effectively replaces structural_dhcp_rst2pdf.genelements.HandleTitle.
    """
...
class FancyHeading(MyImage, Heading):
    ...
    def __init__(self, *args, **kwargs):
        # The initialization is taken from structural_dhcp_rst2pdf.flowables.Heading
    ...
    def drawOn(self, canv, x, y, _sW):
        ...
        # Add outline entry. This is copied from structural_dhcp_rst2pdf.flowables.heading
