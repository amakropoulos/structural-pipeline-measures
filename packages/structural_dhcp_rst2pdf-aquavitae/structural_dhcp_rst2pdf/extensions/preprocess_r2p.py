...
# An extension module for structural_dhcp_rst2pdf
# Copyright 2010, Patrick Maupin
# See LICENSE.txt for licensing terms

"""
preprocess is a structural_dhcp_rst2pdf extension module (invoked by -e preprocess
on the structural_dhcp_rst2pdf command line.

There is a testcase for this file at structural_dhcp_rst2pdf/tests/test_preprocess.txt
...
2) It provides a simplified syntax for documents which are targeted only
   at structural_dhcp_rst2pdf, rather than docutils in general.

The design goal of "base structural_dhcp_rst2pdf" is to be completely compatible with
...
``SingleWordAtLeftColumn``
    ...
    workaround at a lower level in structural_dhcp_rst2pdf.)
