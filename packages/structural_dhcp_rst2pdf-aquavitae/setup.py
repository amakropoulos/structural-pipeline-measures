...
setup(
    name="structural_dhcp_rst2pdf",
    version=version,
    packages=find_packages(exclude=['ez_setup', 'examples', 'tests']),
    package_data=dict(structural_dhcp_rst2pdf=['styles/*.json',
        'styles/*.style',
        'images/*png',
        'images/*jpg',
        'templates/*tmpl'
    ...
    url="http://structural_dhcp_rst2pdf.googlecode.com",
    download_url="http://code.google.com/p/structural_dhcp_rst2pdf/downloads/list",
    entry_points={'console_scripts': ['structural_dhcp_rst2pdf = structural_dhcp_rst2pdf.createpdf:main']},
    test_suite='structural_dhcp_rst2pdf.tests.test_structural_dhcp_rst2pdf.test_suite',
)
